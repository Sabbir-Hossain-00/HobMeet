...
export const SuccessStories = () => {
  ...
  return (
    <section className="container mx-auto px-3 md:px-6 lg:px-8 xl:px-14 py-16 ">
      <div className={` p-10 ${isDark ? "bg-gradient-to-b from-black rounded-2xl to-gray-900]": "bg-gradient-to-b from-amber-50 to-slate-100"}`}>
        {/* Section Title */}
